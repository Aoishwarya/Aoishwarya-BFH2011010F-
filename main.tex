...
a depth of zero.The height of a node is the number of edges from the node to the deepest leaf.The height of a node in a binary tree is the largest number of edges in a path from a leaf node to a target node. The height of a binary tree is the height of the root node in the whole binary tree. In other words, the height of a binary tree is equal to the largest number of edges from the root to the most distant leaf node.
\begin{center}
\includegraphics[width=.90\textwidth]{Tree depth.jpg}
\end{center}
...
\color{blue}reference\cite{alvi2020digital}
reference\cite{das2020bdonor}
\bibliographystyle{ieeetr}
\bibliography{reference.bib}

\begin{center}
\includegraphics[width=.80\textwidth]{My loGo.jpg}
